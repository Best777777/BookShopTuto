...
namespace BookShopTuto
{
    public partial class Billing : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\桌面\BookShopTuto\WhiteBookShopDb.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        {
            e.Graphics.DrawString("小谌书店", new Font("幼圆", 12, FontStyle.Bold), Brushes.Red, new Point(80));
            ...
            e.Graphics.DrawString("***********小谌书店***********", new Font("幼圆", 10, FontStyle.Bold), Brushes.Crimson, new Point(40, pos + 85));
            BillDGV.Rows.Clear();
            BillDGV.Refresh();
            pos = 100;
            GrdTotal = 0;
